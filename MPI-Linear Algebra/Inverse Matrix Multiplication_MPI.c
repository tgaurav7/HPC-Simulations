...
#include "mpi.h"
#include <math.h>
#define e 2.7182182459046
#define pi 3.141592653589793
int main(int argc, char** argv)
{
   int nprocs, anstype, myid, m, rowsent,  sender, Arows=10, Acols=10, Brows, Bcols=10, Crows, Ccols, crow , i, j, k, N, master = 0 ; 
	double **A, B[10][10], C[10][10];
	double ans[10], buff[10];
	MPI_Status status;
